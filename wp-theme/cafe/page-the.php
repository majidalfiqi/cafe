...
<body>
  ...
  <header id="header" class="the-header expanded">
    <a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_url'); ?>/assets/images/logo.png"
        alt="Cafe Logo" /></a>
    <div class="burger">
      <div class="line1"></div>
  ...
  <main id="main" class="the-main">
    ...
    <section class="parags">
      <div class="parag">
        ...
        <img src="<?php bloginfo('template_url'); ?>/assets/images/hero3.jpg" alt="patisseries" />
      </div>
      <div class="parag">
        <div>
          <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2>
        ...
        <img src="<?php bloginfo('template_url'); ?>/assets/images/hero4.jpg" alt="patisseries" />
      </div>
      <div class="parag">
        <div>
          <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2>
        ...
        <img src="<?php bloginfo('template_url'); ?>/assets/images/hero5.jpg" alt="patisseries" />
      </div>
      <div class="parag">
        <div>
          <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2>
